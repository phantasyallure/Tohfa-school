...
window.TOHFA_DICT = {
  fr: {
    ...
    apply: {
      ...
      step1_title: "Vous remplissez le formulaire",
      step1_desc: "Quelques informations, ça prend moins de 2 minutes.",
      step2_title: "Notre équipe vous appelle",
      step2_desc: "Nous vous recontactons sous 48h pour en discuter.",
      step3_title: "Vous finalisez votre inscription",
      step3_desc: "Sur place ou par téléphone, comme vous préférez.",
      call_instead: "Vous préférez nous appeler directement ?",
      call_note: "Du dimanche au jeudi, 9h – 17h.",
      section_you: "Vos coordonnées",
      section_class: "Votre inscription",
    },
    contact: {
  ...
  ar: {
    ...
    apply: {
      ...
      steps_title: "كيف تسير العملية",
      step1_title: "تملأ الاستمارة",
      step1_desc: "بضع معلومات فقط، تستغرق أقل من دقيقتين.",
      step2_title: "يتصل بك فريقنا",
      step2_desc: "نتواصل معك خلال 48 ساعة للمناقشة.",
      step3_title: "تُتمّ تسجيلك",
      step3_desc: "في المدرسة أو عبر الهاتف، كما يناسبك.",
      call_instead: "تفضل الاتصال بنا مباشرة؟",
      call_note: "من الأحد إلى الخميس، من 9 صباحاً إلى 17 مساءً.",
      section_you: "معلوماتك الشخصية",
      section_class: "تسجيلك",
    },
    contact: {
      eyebrow: "تواصل معنا",
      title: "اتصل بنا",
  ...
  en: {
    nav: { home: "Home", about: "About", classes: "Programs", apply: "Apply", contact: "Contact" },
    brand: { sub: "École Tohfa Oran" },
    hero: {
      eyebrow: "Welcome to École Tohfa Oran",
      title_line1: "Learning is more",
      title_line2: "than knowledge:",
      title_gold: "a place for everyone",
      lead: "At École Tohfa Oran, we support children, teenagers and adults on their educational and artistic journey, in a caring and inspiring environment.",
      cta_classes: "Discover our programs",
      cta_apply: "Apply now",
    },
    pillars: {
      kicker: "Our programs",
      title: "What you'll learn with us",
      lead: "A gateway to several worlds, with a rich and varied offering: academics, artistic expression and language mastery.",
      side_note: "Programs suited to every age and every talent.",
      see_all: "Learn more",
      academique: { name: "Academic", desc: "Preschool, preparatory classes, tutoring and continuing courses." },
      artistique: { name: "Arts", desc: "Music, drawing and theatre to develop your talent." },
      langues: { name: "Languages", desc: "Learning, conversation practice and preparation for international exams." },
    },
    values: {
      kicker: "Our approach",
      title: "Why choose Tohfa?",
      item1: { title: "Personalized support", desc: "Individual guidance for every learner." },
      item2: { title: "A creative environment", desc: "Music, art and culture at the heart of our teaching." },
      item3: { title: "Open to all ages", desc: "From children to adults, everyone has a place here." },
      item4: { title: "A passionate team", desc: "Qualified, committed and caring instructors." },
    },
    cta_banner: {
      kicker: "Join us",
      title: "Your future starts here",
      lead: "Enrollment is open. Take a few minutes and get ready for a quick response.",
      button: "Submit my application",
      script: "Together towards a better future",
    },
    footer: {
      quicklinks: "Navigation",
      contact: "Contact",
    ...
    about: {
      eyebrow: "About us",
      title: "École Tohfa Oran",
      lead: "At École Tohfa Oran, we support children, teenagers and adults in their learning and the development of their talents, in an educational and artistic environment.",
      mission_title: "Our mission",
      mission_text: "To offer, in a single place, solid academic support and a space for artistic expression, so that every student can learn, create and grow with confidence — whatever their age.",
      approach_title: "Our approach",
      approach_text: "Our teachers adapt their methods to each student's pace. Tutoring, language learning and art workshops are designed as complementary paths rather than separate tracks.",
      environment_title: "A place designed for learning",
      environment_text: "Our spaces are designed to be both studious and welcoming: classrooms, art studios and spaces dedicated to language practice, located in Fernand Ville, Bir El Djir, Oran.",
    },
    classes: {
      eyebrow: "Programs",
      title: "Our courses",
      lead: "Click on a course to discover its full content.",
      more: "View details",
      modal_apply: "Apply for this course",
      modal_close: "Close",
      filter_all: "All",
    },
    apply: {
      eyebrow: "Enrollment",
      title: "Apply to École Tohfa",
      lead: "Fill out this form in a few minutes, and our team will get back to you to finalize your enrollment.",
      first_name: "First name",
      last_name: "Last name",
      phone: "Phone",
      class: "Desired course",
      class_placeholder: "Choose a course",
      email: "Email",
      note: "Message (optional)",
      note_placeholder: "Add any useful information here: availability, level, specific questions...",
      optional: "optional",
      required_note: "Fields marked with an asterisk (*) are required.",
      submit: "Send my application",
      submitting: "Sending...",
      success_title: "Application sent!",
      success_text: "Thank you! Your request has been received. Our team will contact you shortly at the number provided.",
      success_cta: "Back to home",
      error_text: "An error occurred while sending. Check your connection and try again, or contact us directly by phone.",
      config_warning: "Supabase configuration is not set yet: this form is running in demo mode and does not save anything for now.",
      steps_title: "How it works",
      step1_title: "Fill out the form",
      step1_desc: "A few details — takes less than 2 minutes.",
      step2_title: "Our team calls you",
      step2_desc: "We get back to you within 48 hours to talk it through.",
      step3_title: "You finalize your enrollment",
      step3_desc: "In person or by phone, whichever suits you.",
      call_instead: "Prefer to call us directly?",
      call_note: "Sunday to Thursday, 9am – 5pm.",
      section_you: "Your details",
      section_class: "Your enrollment",
    },
    contact: {
      eyebrow: "Contact us",
      title: "Contact",
      lead: "Have a question? Contact us directly, or come visit us in Bir El Djir.",
      address_label: "Address",
      phone_label: "Phone",
      whatsapp_label: "WhatsApp",
      social_label: "Social media",
      map_title: "Find us on the map",
      details_title: "Our contact details",
    },
  },
};
...
(function () {
  ...
  function closeAllLangMenus() {
    document.querySelectorAll("[data-lang-switch].open").forEach((wrap) => {
      ...
      const toggle = wrap.querySelector(".lang-globe-btn");
  ...
  function initLanguage() {
    ...
    const lang = ["ar", "fr", "en"].includes(saved) ? saved : "fr";
    applyLanguage(lang);

    /* Globe icon: click opens/closes its own dropdown (fr / ar / en,
       each with a flag — Algeria for Arabic). Picking a language
       applies it and closes the menu; clicking anywhere else, or
